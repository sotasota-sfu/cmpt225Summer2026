...
// TODO 4: Implement min_key_rec (using recursion).
...
// TODO 5: Implement min_key_loop (using a loop and no recursion).
...
// TODO 6: Implement max_key_rec (using recursion).
...
// TODO 7: Implement max_key_loop (using a loop and no recursion).
...
// TODO 8: Implement is_bst (using the functions you implemented above to help).
...
// TODO 9: Implement print_inorder.
...
// TODO 10: Implement contains_rec (using recursion).
...
// TODO 11: Implement contains_loop (using a loop and no recursion).
...
// TODO 12: Implement clear (using recursion).
...
// TODO 13: Implement leaf_insert

// inserts k as a new leaf node in the tree rooted at p (preserving the BST
// property)
// void leaf_insert(Node*& p, int k)
// {
//     assert(is_bst(p));
//     // ...
//     assert(is_bst(p)); // make sure the tree is still a BST
// }
